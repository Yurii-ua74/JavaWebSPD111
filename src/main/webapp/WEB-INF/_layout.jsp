...
<head>
    ...
    <link rel="icon" href="<%=context%>/img/java-logo.jpg" />
    ...
    <nav>
        <div class="nav-wrapper brown">
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a href="<%=context%>/shop"><i class="material-icons">add_box</i></a></li>
                ...
                <li><a href="<%=context%>/addProduct"><i class="material-icons">add_box</i></a></li>
...
<div id="auth-modal" class="modal">
    <div class="col s12">
        ...
        <div class="modal-footer">
            ...
            <button class="btn-flat brown white-text" style="margin-left:15px" id="auth-button">Вхід</button>
        </div>
    </div>
</div>
